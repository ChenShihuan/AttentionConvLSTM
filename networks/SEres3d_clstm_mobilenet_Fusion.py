...
def Res3D_Block1(inputs, weight_decay, str_modality):
  ...
  SEnet_1 = keras.layers.Lambda(SEnet, arguments={'channel':64, 'reduction_ratio':4},name='SE_Block_1_%s'%str_modality)(conv3d_1)
  return SEnet_1
...
def Res3D_Block2(inputs, weight_decay, str_modality): 
  ...
  # return conv3d_2b
  SEnet_2 = keras.layers.Lambda(SEnet, arguments={'channel':64, 'reduction_ratio':4},name='SE_Block_2_%s'%str_modality)(conv3d_2b)
  return SEnet_2
...
def Res3D_Block3(inputs, weight_decay, str_modality):
  ...
  # return conv3d_3b
  SEnet_3 = keras.layers.Lambda(SEnet, arguments={'channel':128, 'reduction_ratio':4},name='SE_Block_3_%s'%str_modality)(conv3d_3b)
  return SEnet_3
...
def Res3D_Block4(inputs, weight_decay, str_modality):
  ...
  # return conv3d_4b
  SEnet_4 = keras.layers.Lambda(SEnet, arguments={'channel':256, 'reduction_ratio':4},name='SE_Block_4_%s'%str_modality)(conv3d_4b)
  return SEnet_4
