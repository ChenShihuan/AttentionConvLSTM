...
#   pretrained_model = '%s/jester_%s_gatedclstm_weights.h5'%(model_prefix,str_modality)
    pretrained_model = '/disk1/shchen/AttenConvLSTM_models/models_old/Gate/isogr_rgb_weights.08-2.75.h5'
elif cfg_dataset==ISOGD:
#   pretrained_model = '%s/isogr_%s_gatedclstm_weights.h5'%(model_prefix,str_modality)
    pretrained_model = '/disk1/shchen/AttenConvLSTM_models/models_old/isogr_rgb_gatedclstm_weights.h5'
